...
namespace Adaptive.Aeron.Samples.Common
{
    ...
    public class SamplesUtil
    {
        ...
        {
            return FragmentHandlerHelper.ToFragmentHandler((buffer, offset, length, header) =>
            {
        ...
        {
            return FragmentHandlerHelper.ToFragmentHandler((buffer, offset, length, header) => reporter.OnMessage(1, length));
        }
