...
namespace Adaptive.Aeron
{
    ...
    public class Image
    {
...
#endif
        {
            return Poll(fragmentHandler.OnFragment, fragmentLimit);
        }
        ...
        {
            return ControlledPoll(fragmentHandler.OnFragment, fragmentLimit);
        }
        ...
        public virtual int BoundedControlledPoll(IControlledFragmentHandler fragmentHandler, long maxPosition,
            int fragmentLimit)
        {
            return BoundedControlledPoll(fragmentHandler.OnFragment, maxPosition, fragmentLimit);
        }
        ...
        {
            return ControlledPeek(initialPosition, fragmentHandler.OnFragment, limitPosition);
        }
